        ...
        private void UpdatePreview(bool first)
        {
            ...
            else
            {
                ...
                switch (this.Texture.Format)
                {
                    ...
                    {
                        data = new byte[mip.Width * mip.Height * 4];
                        Squish.DecompressImage(data, mip.Width, mip.Height, mip.Data, Squish.Flags.DXT1);
                        break;
                    }
                    ...
                    {
                        data = new byte[mip.Width * mip.Height * 4];
                        Squish.DecompressImage(data, mip.Width, mip.Height, mip.Data, Squish.Flags.DXT3);
                        break;
                    }
                    ...
                    {
                        data = new byte[mip.Width * mip.Height * 4];
                        Squish.DecompressImage(data, mip.Width, mip.Height, mip.Data, Squish.Flags.DXT5);
                        break;
                    }
